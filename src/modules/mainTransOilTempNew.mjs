                    ...
                    onmount: function () {
                        ...
                        jam.ajaxCall({
                            ...
                            onsuccess(res) {
                                ...
                                _model['event-chart-pie-info'] = `油温统计共&nbsp;<b style="color:${jam.colorText()};">${sum}</b>&nbsp;条，${sum > 0 ? `${maxName}最多，占总数&nbsp;<b style="color:${jam.colorText()};">${Math.trunc((maxValue / sum) * 100)}</b>&nbsp;%` : ''}`;
                                chart_model.data.chartData = [['油温', '数量'], ...dataList];
                            }
                        });
                    },
                    styles: ['tagWithPictorialBar.basic', 'css(width:100%;height:calc(100% - 1.6rem);)'],
