...
import onlineMonitiorWindow from '../components/modal/onlineMonitiorWindow.js';
                        ...
                        },
                        {
                            ...
                            components: [
                                ...
                                },
                                {
                                    ...
                                    icon: 'file-export',
                                    onclick: function () {
                                        exportExcel(urlConfig['exportOperationStatusData'].url, packageParams(), `运行状态监测_${moment().format('yyyyMMDDHHmmssSSS')}.xlsx`, 'post');
                                    }
                                }
                            ]
                        }
            ...
            components: [
                {
                    ...
                    dataWatcher: 'onlineMonitiorData',
                    dataDef: [
                        {
                            key: 'keyIdStr',
                            show: false
                            ...
                            formatter: (uuid) => {
                                return jame({
                                    ...
                                    onclick: (e) => {
                                        ...
                                        const _tableData = _msgr.get('onlineMonitiorData') || [];
                                        ...
                                        createWindow({
                                            ...
                                            width: '60vw',
                                            height: '20vw',
                                            body: onlineMonitiorWindow(_rowData),
                                            showBtn: false
                                        });
                                    }
                                });
...
function initTableData(page) {
    ajaxCall('getOperationStatusData', {
        params: { ...getPagerParams(page), ...packageParams() },
        type: 'post',
        useMock: false,
        success(data) {
            _msgr.pub('onlineMonitiorData', data.list || []);
...
function packageParams() {
    ...
    const deviceSystem = _model.vars.deviceSystem || undefined;
    const level = _model.vars.eventLevel || undefined;
    const params = {
        deviceSystem,
        regionId,
        level,
